...
Transfer students face advising challenges that conventional systems do not address well: records are split across institutions, and predictive models are typically trained on students who entered as freshmen. We present ACOSUS, an AI-driven advising platform designed specifically for transfer students. The system incorporates a dual-survey approach that separates outcome measurement from predictor collection and a progressive learning framework suitable for institutions with limited data. A pilot study found positive participant ratings of perceived usefulness and ease of use, supporting the feasibility of the system and its survey workflow. The platform is now deployed and collecting data for future evaluation.
...
\bottomrule
\multicolumn{5}{@{}p{0.92\columnwidth}@{}}{\footnotesize\textit{Note.} Behavioral-intention items have $N=8$; two participants did not provide a usable rating.} \\
\bottomrule
\end{tabular}
\end{table}
