...
\begin{center}
\LARGE
\textbf{An AI-driven Transfer Student Advising System: Design, Implementation, and User Study}\\[12pt]
\normalsize
...
\node[plug=stage3, below=0.12cm of s3-content, text width=3cm, minimum height=0.9cm] (s3-plug) {Pluggable: Any deep\\learning architecture\\(e.g., neural networks, gradient boosting)};
