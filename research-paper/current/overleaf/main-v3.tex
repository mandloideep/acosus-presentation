...
\textbf{Survey Linkage:} The dual-survey architecture uses explicit linkage settings. A single Target Survey (outcome $Y$) may be linked to multiple Factor Surveys (predictor sets $X_1, X_2, X_3$), which allows researchers to examine which predictor combinations perform best. This arrangement provides several practical advantages:
