...
\node[font=\scriptsize\bfseries, text=inputred, anchor=north] (input-title) at ([xshift=-1.8cm, yshift=-8pt]stage1-box.north west) {DATA INPUT};
...
\node[inner, fill=white, draw=outputviolet!80, text width=2.4cm, anchor=south] (output-inner) at ([xshift=-1.8cm, yshift=8pt]stage1-box.south west) {Readiness Score};
