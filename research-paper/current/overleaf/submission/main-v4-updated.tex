...
To show how the starting priorities affect the result, we recalculated scores for the available deidentified pilot profiles under three alternative scenarios. The analysis used the factor responses represented across those profiles and the same priority-weighted calculation in each scenario. Table~\ref{tab:sensitivity} reports the resulting sensitivity comparison.
